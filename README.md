...
## Features
- **USB-BLE Bridge**: Receives commands via Serial (USB) and retransmits them as HID (Bluetooth).
- **On-Screen Terminal**: Displays connection logs and received commands on the Flipper display.

## How to Use
1. Install the `hid_ble_bridge.fap` app on the Flipper Zero (`apps/Bluetooth/`).
